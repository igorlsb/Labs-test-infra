...
**Acesse** `https:///grafana.dominioteste.com`  
**Login:** `admin` | Senha: `admin`  
Vá para **Configurações** → **Data Sources** → **Adicionar nova fonte**  
**Adicione Prometheus**:
...
7. **Sistema Gerenciado:** Criei um sistema em que o frontend, backend e banco PostgreSQL se conversam e interagem pelo frontend.
